...
.nev{
	...
	margin-right: 20px;
		...
		<body>
		  ...
		  <div class="module">     <h1> Admin Register</h1>
		    <form class="form" action="admin_register.php" method="post" enctype="multipart/form-data" >
		      ...
		      <input type="submit" value="Log In" name="log in" class="btn btn-block btn-primary" onclick="location.href='admin_login.php';" />
		        ...
		        if (isset($_POST['register'])) { 
		           ...
		           if($password==$cpassword){
		            ...
		            if (mysqli_num_rows($query_run)>0) {
		              ...
		              $hash = sha1($password);
		              $query="insert into admin_user (nic_no,email,password) values ('$nic_no','$email','$hash')";
		              $query_run = mysqli_query($con,$query);
		              if ($query_run) {
